...
try:
    ...
    workbook = load_workbook(r'C:\Users\bruno.ribeiro\Desktop\Scripts Indicadores\Indicadores-Fieldy.xlsx')
    # Selecão da página onde terá os Appends
    worksheet = workbook['Tasks Fieldy']
    ...
    workbook.save(r'C:\Users\bruno.ribeiro\Desktop\Scripts Indicadores\Indicadores-Fieldy.xlsx')
