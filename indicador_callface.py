...
try:
    ...
    df_power_bi = pd.read_csv(r'C:\Users\bruno.ribeiro\Desktop\Callface Tasks\Callface Platform.csv')
    ...
    workbook = load_workbook(r'C:\Users\bruno.ribeiro\Desktop\Scripts Indicadores\Indicadores-Callface.xlsx')
    # Selecão da página onde terá os Appends
    worksheet = workbook['Tasks Callface']
    ...
    workbook.save(r'C:\Users\bruno.ribeiro\Desktop\Scripts Indicadores\Indicadores-Callface.xlsx')
