...
try:
    ...
    df_power_bi = pd.read_csv(r'C:\Users\bruno.ribeiro\Desktop\Boty Tasks\Boty Tasks.csv')
    ...
    workbook = load_workbook(r'C:\Users\bruno.ribeiro\Desktop\Scripts Indicadores\Indicadores-Boty.xlsx')
    # Selecão da página onde terá os Appends
    worksheet = workbook['Tasks Boty']
    ...
    workbook.save(r'C:\Users\bruno.ribeiro\Desktop\Scripts Indicadores\Indicadores-Boty.xlsx')
